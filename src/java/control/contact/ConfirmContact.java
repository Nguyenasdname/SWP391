...
public class ConfirmContact extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConfirmContact</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConfirmContact at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Contact contact = new Contact(1, user.getUserId(), contactTitle, contactContent, null, null, null);
        
        contactDao.addContact(contact);
        
        response.sendRedirect("index.jsp?alertMessage=Thank You!");
