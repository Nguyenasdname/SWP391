...
public class AddService extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Villa villa = villaDao.getVillaByID(booking.getVillaId());
        
        ArrayList<Service> listService = serviceDao.getAllServiceList();
        
        request.setAttribute("booking", booking);
        request.setAttribute("basePrice", booking.getBookingTotal());
        request.setAttribute("villa", villa);
        request.setAttribute("listService", listService);
        
        request.getRequestDispatcher("addMoreService.jsp").forward(request, response);
    }
