 ...
 * @author Dai Nhan
 */
@WebServlet(name = "AdmingetAllServices", urlPatterns = {"/admin-get-services"})
   ...
   private ServiceDaoImp serviceDaoImp;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdmingetAllServices</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdmingetAllServices at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Handle the error without forwarding after response is committed
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "An error occurred while fetching service data.");
        }
    }
